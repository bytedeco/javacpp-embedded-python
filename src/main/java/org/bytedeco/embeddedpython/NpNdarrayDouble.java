...
public class NpNdarrayDouble extends NpNdarray {
    ...
    public NpNdarrayDouble(double[] data, int[] shape, int[] strides) {
        super(shape, strides);
        if (data == null) throw new NullPointerException("data = null");
        this.data = data;
    }

    public NpNdarrayDouble(double[] ary) {
    ...
    public NpNdarrayDouble(double[][] ary) {
        ...
        double[] data = new double[intAryProduct(shape)];
    ...
    public double[][] toArray2d() {
        ...
        int[] strides = this.strides;
        double[][] ary = new double[shape[0]][shape[1]];
        for (int i = 0; i < ary.length; i++) {
    ...
    public double[][][] toArray3d() {
        ...
        int[] strides = this.strides;
        double[][][] ary = new double[shape[0]][shape[1]][shape[2]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
    ...
    public double[][][][] toArray4d() {
        ...
        int[] strides = this.strides;
        double[][][][] ary = new double[shape[0]][shape[1]][shape[2]][shape[3]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
    ...
    public double[][][][][] toArray5d() {
        if (ndim() != 5) throw new RuntimeException("ndim != 5");

        int[] strides = this.strides;
        double[][][][][] ary = new double[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public double[][][][][][] toArray6d() {
        if (ndim() != 6) throw new RuntimeException("ndim != 6");

        int[] strides = this.strides;
        double[][][][][][] ary = new double[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public double[][][][][][][] toArray7d() {
        if (ndim() != 7) throw new RuntimeException("ndim != 7");

        int[] strides = this.strides;
        double[][][][][][][] ary = new double[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]][shape[6]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public double[][][][][][][][] toArray8d() {
        if (ndim() != 8) throw new RuntimeException("ndim != 8");

        int[] strides = this.strides;
        double[][][][][][][][] ary = new double[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]][shape[6]][shape[7]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
