...
public class NpNdarrayLong extends NpNdarray {
    ...
    public long[][][][] toArray4d() {
        ...
        int[] strides = this.strides;
        long[][][][] ary = new long[dimensions[0]][dimensions[1]][dimensions[2]][dimensions[3]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
    ...
    public long[][][][][] toArray5d() {
        ...
        int[] strides = this.strides;
        long[][][][][] ary = new long[dimensions[0]][dimensions[1]][dimensions[2]][dimensions[3]][dimensions[4]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public long[][][][][][] toArray6d() {
        ...
        int[] strides = this.strides;
        long[][][][][][] ary = new long[dimensions[0]][dimensions[1]][dimensions[2]][dimensions[3]][dimensions[4]][dimensions[5]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public long[][][][][][][] toArray7d() {
        ...
        int[] strides = this.strides;
        long[][][][][][][] ary = new long[dimensions[0]][dimensions[1]][dimensions[2]][dimensions[3]][dimensions[4]][dimensions[5]][dimensions[6]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public long[][][][][][][][] toArray8d() {
        ...
        int[] strides = this.strides;
        long[][][][][][][][] ary = new long[dimensions[0]][dimensions[1]][dimensions[2]][dimensions[3]][dimensions[4]][dimensions[5]][dimensions[6]][dimensions[7]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
